  ...
  <div class="w-layout-blockcontainer container-2 w-container">
    ...
    <div class="w-form">
      <form id="email-form" name="email-form" data-name="Email Form" method="post" class="form" action="register.php"
        ...
        <input class="w-input" maxlength="256" name="password" data-name="password" placeholder="" type="text"
          id="password" required="" />
        <label for="email-2" class="field-label">Conferma Password</label>
        <input class="text-field w-input" maxlength="256" name="psw-2" data-name="Email 2" placeholder="" type="text"
          id="psw-2" required="" />
